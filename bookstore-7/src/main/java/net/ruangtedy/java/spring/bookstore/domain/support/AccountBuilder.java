...
import net.ruangtedy.java.spring.bookstore.domain.Permission;
import net.ruangtedy.java.spring.bookstore.domain.Role;
/**
...
public class AccountBuilder extends EntityBuilder<Account>{
	...
	public AccountBuilder address(String city, String postalCode, String street, String houseNumber, String boxNumber, String country){
